...
class PenTool: UIBezierPath, SketchTool {
    ...
    init(path: CGMutablePath, lineColor: UIColor, lineAlpha: CGFloat, drawingPenType: PenType, coordinates:[Coordinates], backupPath: CGMutablePath?, index: Int?){
        self.path = path
        self.lineColor = lineColor
        self.lineAlpha = lineAlpha
        self.drawingPenType = drawingPenType
    ...
    func createSubPath(previousPoint2: CGPoint, previousPoint1: CGPoint, currentPoint: CGPoint) -> CGMutablePath {
